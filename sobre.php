...
<br>
	...
	<!-- ////////// RESTANTE DO SITE ABAIXO SEU GAY -->
<div class="w3-container">
  <div class="w3-card-4 " style="margin-top: 80px; margin-right: 100px; margin-left: 100px";>
    <header class="w3-container w3-round-large" style="background-color: #A90E10";>
      <h1> <center> <font color="white"> Biblioteca de Conclusão de Curso  </font> </center> </h1>
    </header>

    <div class="w3-container">
      <p>O projeto intitulado como BTCC, (abreviação para Biblioteca de Trabalho de Conclusão de Curso) é um website que vem com o principal intuito de facilitar e auxiliar a vida acadêmica dos alunos de ensino técnico da ETEC Philadelpho Gouveia Netto de modo primordial, respondendo as dúvidas mais frequentes referentes aos TCCs, disponibilizando a retirada dos mesmos com diversos temas separados por cursos divergentes pelo próprio site via agendamento, e até mesmo mostrando de forma antecipada a acessibilidade destes, sendo tudo acoplado ao sistema da biblioteca da instituição onde será feita a retirada dos documentos, ou seja, os TCCs situados anteriormente tem como base a escola também citada previamente.</p>
      <p> Na contemporaneidade, é evidente a importância dos TCCs na formação dos alunos de ensino técnico e superior. Por conseguinte, especificando os discentes da escola Philadelpho Gouvêa Netto, há vários empecilhos que deixam os alunos aflitos, como não ter ideia para começar o seu projeto, que ferramentas usar, normas padrões e, além desses, há também uma defasagem na usabilidade referente a biblioteca (responsável por disponibilizar os TCCs da instituição), causada por diversos fatores como falta de políticas públicas, má regulamentação das normas da mesma e entre outros. E é com base nestas adversidades que foi criado o BTCC, um website para auxiliar e facilitar a vida dos acadêmicos acoplado a biblioteca escolar como já citado anteriormente. </p>
 </div>
</div>
</div>
...
<br />
		...
		<div class="w3-container w3-center" style="background-color: #4a555c; color: white; margin-top: 55px";>			
